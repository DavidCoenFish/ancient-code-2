...
function GameModeRanking(in_game)
{
	//DEBUG if ( !(this instanceof GameModeRanking) )
	//DEBUG {
	//DEBUG 	alert("GameModeRanking: call constuctor with new keyword");
	//DEBUG }
	...
	m_arrayGui.push(new GuiText("RANKING", new Vector(4, 4)));
