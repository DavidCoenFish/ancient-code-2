//gamemodeonlinebattle.js

function GameModeOnlineBattle(in_game)
{
	//DEBUG if ( !(this instanceof GameModeOnlineBattle) )
	//DEBUG {
	//DEBUG 	alert("GameModeOnlineBattle: call constuctor with new keyword");
	//DEBUG }
	...
	m_arrayGui.push(new GuiText("ONLINE BATTLE", new Vector(4, 4)));
