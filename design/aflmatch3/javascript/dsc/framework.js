DSC.Framework = function(_document, _task, _paramObject)
{
	...
	this.m_taskArray = (undefined != _task) ? [_task] : [];
...
DSC.Framework.prototype.RequestAnimationFrameCallback = function(in_timeStamp)
{
	var timeDelta = this.IncrementTime(in_timeStamp);

	this.m_runKeepGoing = false;
	if (0 < this.m_taskArray.length) //run the last task
...
DSC.Framework.prototype.IncrementTime = function(in_timeStamp)
{
	var timeDelta = 0.0;
