...
DSC.Framework.Asset.Shader.FactoryRaw = function(
	in_context,
	in_vertexShaderSource,
	in_fragmentShaderSource,
	in_mapVertexAttribute, 
...
{
	return new DSC.Framework.Asset.Shader(in_context, in_mapVertexAttribute, in_mapUniform, in_vertexShaderSource, in_fragmentShaderSource);
}
