 ...
 * @constructor
 * @struct
 * @this {!DSC.Framework.Context.WebGL}
 * @param {!object} in_canvas
 * @param {!object=} _paramObject
 */
DSC.Framework.Context.WebGL = function(in_canvas, _paramObject)
{
	...
	this.SetViewport(0, 0, in_canvas.width, in_canvas.height);

	return;
}
DSC.Framework.Context['WebGL'] = DSC.Framework.Context.WebGL;


/**
 * @param {!object) in_canvas
 * @param {!object=) _paramObject
 * @return {DSC.Framework.Context.WebGL}
 */
DSC.Framework.Context.WebGL.Factory = function(_canvas, _paramObject)
{
	return new DSC.Framework.Context.WebGL(_canvas, _paramObject);
}
...
DSC.Framework.Context.WebGL['POINTS'] = DSC.Framework.Context.WebGL.POINTS;
DSC.Framework.Context.WebGL.LINES = 1;
DSC.Framework.Context.WebGL['LINES'] = DSC.Framework.Context.WebGL.LINES;
DSC.Framework.Context.WebGL.LINE_LOOP = 2;
DSC.Framework.Context.WebGL['LINE_LOOP'] = DSC.Framework.Context.WebGL.LINE_LOOP;
DSC.Framework.Context.WebGL.LINE_STRIP = 3;
DSC.Framework.Context.WebGL['LINE_STRIP'] = DSC.Framework.Context.WebGL.LINE_STRIP;
DSC.Framework.Context.WebGL.TRIANGLES = 4;
DSC.Framework.Context.WebGL['TRIANGLES'] = DSC.Framework.Context.WebGL.TRIANGLES;
DSC.Framework.Context.WebGL.TRIANGLE_STRIP = 5;
DSC.Framework.Context.WebGL['TRIANGLE_STRIP'] = DSC.Framework.Context.WebGL.TRIANGLE_STRIP;
DSC.Framework.Context.WebGL.TRIANGLE_FAN = 6;
DSC.Framework.Context.WebGL['TRIANGLE_FAN'] = DSC.Framework.Context.WebGL.TRIANGLE_FAN;
...
DSC.Framework.Context.WebGL['BYTE'] = DSC.Framework.Context.WebGL.BYTE;
DSC.Framework.Context.WebGL.UNSIGNED_BYTE  = 0x1401;
DSC.Framework.Context.WebGL['UNSIGNED_BYTE'] = DSC.Framework.Context.WebGL.UNSIGNED_BYTE;
DSC.Framework.Context.WebGL.SHORT          = 0x1402;
DSC.Framework.Context.WebGL['SHORT'] = DSC.Framework.Context.WebGL.SHORT;
DSC.Framework.Context.WebGL.UNSIGNED_SHORT = 0x1403;
DSC.Framework.Context.WebGL['UNSIGNED_SHORT'] = DSC.Framework.Context.WebGL.UNSIGNED_SHORT;
DSC.Framework.Context.WebGL.INT            = 0x1404;
DSC.Framework.Context.WebGL['INT'] = DSC.Framework.Context.WebGL.INT;
DSC.Framework.Context.WebGL.UNSIGNED_INT   = 0x1405;
DSC.Framework.Context.WebGL['UNSIGNED_INT'] = DSC.Framework.Context.WebGL.UNSIGNED_INT;
DSC.Framework.Context.WebGL.FLOAT          = 0x1406;
DSC.Framework.Context.WebGL['FLOAT'] = DSC.Framework.Context.WebGL.FLOAT;
...
/**
 * @param {!DSC.Math.Bound2.Factory=) _result
	...
	if (undefined != _colour)
	{
		if (this.m_webGL)
		{
			...
			this.m_webGL.clearColor(
				DSC.Math.ColourRGBA.GetRed(_colour),
				DSC.Math.ColourRGBA.GetGreen(_colour),
				DSC.Math.ColourRGBA.GetBlue(_colour),
				DSC.Math.ColourRGBA.GetAlphaSafe(_colour, 1,0)
				);
		}
		this.GetError();
	}
