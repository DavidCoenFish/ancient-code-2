...
todo: pass in frame to allow client side calculation of frame bounds
	...
	uniform 
		...
		u_matrixMV: mat4
*/
DSC.Framework.Pool.Shader.APos2USphere4UColour4UMatrixMV = 
{
...
{\
	...
	"m_mapUniformsNames" : {
		"u_sphere" : DSC.Framework.Asset.Shader.Uniform.Factory(DSC.Framework.Context.Uniform.s_type.TVector4),
		"u_colour" : DSC.Framework.Asset.Shader.Uniform.Factory(DSC.Framework.Context.Uniform.s_type.TColour4),
		"u_screen" : DSC.Framework.Asset.Shader.Uniform.Factory(DSC.Framework.Context.Uniform.s_type.TVector4),
		"u_matrixMV" : DSC.Framework.Asset.Shader.Uniform.Factory(DSC.Framework.Context.Uniform.s_type.TMatrix4),
		}
}
